...
android {
    namespace = "com.example.messenger"; compileSdk = 34
    defaultConfig { applicationId = "com.example.messenger"; minSdk = 24; targetSdk = 34; versionCode = 1; versionName = "1.0" }
...
dependencies {
    ...
    implementation("com.google.firebase:firebase-bom:32.7.0"); implementation("com.google.firebase:firebase-auth-ktx")
